...
subprocess.run(['git', 'commit', '-m', 'Add SEO routes for sitemap and robots.txt to all Flask apps'], cwd=r'e:\_free downloader Projext')
...
cmds = [
    ...
    "systemctl restart yt fb insta tiktok p_d freedownloader freestore"
]
